...
RSpec.describe MissingPostsController, type: :controller do
  render_views
  image_src = File.join(Rails.root, "public/uploads/missing_post/image/1/background23.jpg")
  src_file = File.new(image_src)

  let(:valid_attributes) {
    {reporter_name: 'ebram', age: 10, gender: true, location: 'Egypt', description: 'tall', special_signs:'no',reporter_phone: 01125215574,:image =>src_file}
  }
  ...
  describe "GET #edit" do
    it "assigns the requested missing_post as @missing_post" do
      ...
      missing_post.reporter_phone = 01125215574
